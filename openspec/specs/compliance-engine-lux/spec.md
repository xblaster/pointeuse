# Spec: Compliance Engine (Luxembourg)

## Purpose

Ensure time-tracking sessions comply with Luxembourg labour law, monitoring continuous work duration, daily maximums, and weekly maximums. The engine produces alerts and can apply automatic deductions when violations are detected.
